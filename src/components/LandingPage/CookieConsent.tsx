    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div className="relative w-full max-w-4xl mx-4 md:mx-auto m-6 rounded-lg bg-white p-7 shadow-lg z-50 md:flex md:items-center md:justify-between md:gap-6 animate-fadeIn">
        <div className="text-sm md:text-base text-gray-800 mb-4 md:mb-0">
          <p>
            Utilizamos cookies para mejorar tu experiencia en nuestra plataforma de noticias,
            turismo y revistas. Estas nos ayudan a entender mejor tus intereses para ofrecerte
            contenido relevante. Puedes aceptar o rechazar su uso. Consulta nuestra{' '}
            <a href="/politica-de-cookies" className="text-blue-900 underline hover:text-blue-800">
              Política de cookies
            </a>
            .
          </p>
